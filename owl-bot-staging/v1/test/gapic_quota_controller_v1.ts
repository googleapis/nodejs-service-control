...
describe('v1.QuotaControllerClient', () => {
    ...
    describe('allocateQuota', () => {
        it('invokes allocateQuota without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.servicecontrol.v1.AllocateQuotaRequest());
            request.serviceName = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.servicecontrol.v1.AllocateQuotaResponse());
            ...
            assert((client.innerApiCalls.allocateQuota as SinonStub)
