...
describe('v1.ServiceControllerClient', () => {
    ...
    describe('check', () => {
        it('invokes check without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.servicecontrol.v1.CheckResponse());
    ...
    describe('report', () => {
        it('invokes report without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.servicecontrol.v1.ReportResponse());
