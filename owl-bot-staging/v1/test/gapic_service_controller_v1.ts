...
describe('v1.ServiceControllerClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = servicecontrollerModule.v1.ServiceControllerClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = servicecontrollerModule.v1.ServiceControllerClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('check', () => {
        it('invokes check without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CheckRequest', ['serviceName']);
            ...
            const actualRequest = (client.innerApiCalls.check as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.check as SinonStub)
        ...
        it('invokes check without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.check(
                    request,
                    (err?: Error|null, result?: protos.google.api.servicecontrol.v1.ICheckResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('report', () => {
        it('invokes report without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ReportRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.report as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.report as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes report without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.report(
                    request,
                    (err?: Error|null, result?: protos.google.api.servicecontrol.v1.IReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
